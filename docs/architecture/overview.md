...
| capacidade | benchmark local executado; latência atingida e vazões não atingidas no ambiente medido | ensaios representativos e dimensionamento horizontal antes de comprometer SLO |
