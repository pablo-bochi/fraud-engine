...
A IA apoiou a implementação da ferramenta e a interpretação do ensaio U8; os números de capacidade foram produzidos pela execução local registrada, não por geração ou estimativa. Também não substituiu decisões jurídicas ou operacionais sobre LGPD, segurança e prontidão produtiva.
